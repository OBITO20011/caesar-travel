...
function VisaPage() {
  ...
  <><Helmet>
    ...
    <section
      ...
      style={{
        backgroundImage: "url('/images/usa-banner.png')",
      }}
    >
  ...
  تأشيرة  الولايات المتجدة الأمريكية 
</h1>

        <p className="mt-6 text-xl leading-9 text-white/90">
         نوفر إصدار تأشيرات الولايات المتجدة الأمريكية السياحية والزيارة والأعمال بسرعة
...
<div className="rounded-3xl bg-white shadow-lg p-8 text-center hover:shadow-2xl transition">
  ...
  <h3 className="text-2xl font-bold">تأشيرة الولايات المتجدة الأمريكية</h3>
  <p className="mt-3 text-gray-600">
    إصدار تأشيرات الولايات المتجدة الأمريكية بسرعة مع متابعة كاملة حتى صدورها.
  </p>
</div>
...
<div className="rounded-3xl bg-white shadow-lg p-8 text-center hover:shadow-2xl transition">
  ...
  <p className="mt-3 text-gray-600">
    تأشيرة عبور للمسافرين عبر الولايات المتجدة الأمريكية.
  </p>
</div>
...
<div className="rounded-3xl bg-white shadow-lg p-8 text-center hover:shadow-2xl transition">
  ...
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="text-center mb-14">
      <h2 className="text-5xl font-black">
        متطلبات تأشيرة الولايات المتجدة الأمريكية
      </h2>
  ...
  <a
    href="https://wa.me/962798337711?text=مرحباً، أود التقديم على تأشيرة الولايات المتجدة الأمريكية."
    target="_blank"
