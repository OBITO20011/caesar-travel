...
function VisaPage() {
  ...
  <><section
      ...
      style={{
        backgroundImage: "url('/images/schengen-banner.png')",
      }}
    >
  ...
  تأشيرة  شنغن
        ...
        <p className="mt-6 text-xl leading-9 text-white/90">
         نوفر إصدار تأشيرات شنغن السياحية والزيارة والأعمال بسرعة
...
<div className="rounded-3xl bg-white shadow-lg p-8 text-center hover:shadow-2xl transition">
  ...
  <h3 className="text-2xl font-bold">تأشيرة شنغن</h3>
...
<div className="rounded-3xl bg-white shadow-lg p-8 text-center hover:shadow-2xl transition">
  ...
  <p className="mt-3 text-gray-600">
    تأشيرة عبور للمسافرين عبر شنغن.
  </p>
</div>
...
<div className="rounded-3xl bg-white shadow-lg p-8 text-center hover:shadow-2xl transition">
  ...
  <a
    href="https://wa.me/962798337711?text=مرحباً، أود التقديم على تأشيرة شنغن."
    target="_blank"
