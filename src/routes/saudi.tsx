...
function VisaPage() {
  ...
  تأشيرة المملكة العربية السعودية
        ...
        <p className="mt-6 text-xl leading-9 text-white/90">
         نوفر إصدار تأشيرات السعودية السياحية والزيارة والأعمال بسرعة
...
<div className="rounded-3xl bg-white shadow-lg p-8 text-center hover:shadow-2xl transition">
  ...
  <h3 className="text-2xl font-bold">تأشيرة العمرة</h3>
...
<div className="rounded-3xl bg-white shadow-lg p-8 text-center hover:shadow-2xl transition">
  ...
  <p className="mt-3 text-gray-600">
    تأشيرة عبور للمسافرين عبر المملكة العربية السعودية.
  </p>
</div>
...
<div className="rounded-3xl bg-white shadow-lg p-8 text-center hover:shadow-2xl transition">
  ...
  <a
    href="https://wa.me/962798337711?text=مرحباً، أود التقديم على تأشيرة السعودية."
    target="_blank"
