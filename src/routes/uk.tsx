...
function VisaPage() {
  return (
  <VisaCountryPage slug="uk" fallbackContent={
  <><Helmet>
  ...
  تأشيرة  المملكة المتحدة
        ...
        <p className="mt-6 text-xl leading-9 text-white/90">
         نوفر إصدار تأشيرات المملكة المتحدة السياحية والزيارة والأعمال بسرعة
...
<div className="rounded-3xl bg-white shadow-lg p-8 text-center hover:shadow-2xl transition">
  ...
  <h3 className="text-2xl font-bold">تأشيرة المملكة المتحدة</h3>
...
<div className="rounded-3xl bg-white shadow-lg p-8 text-center hover:shadow-2xl transition">
  ...
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="text-center mb-14">
      <h2 className="text-5xl font-black">
        متطلبات تأشيرة المملكة المتحدة
      </h2>
  ...
  <a
    href="https://wa.me/962798337711?text=مرحباً، أود التقديم على تأشيرة المملكة المتحدة."
    target="_blank"
